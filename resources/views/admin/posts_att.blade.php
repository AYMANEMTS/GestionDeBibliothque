...
@section('moder2')
    ...
    <div class="container-fluid" >
        ...
        @endif
        <a href="{{ route('moder.postsacc') }}" class="btn btn-primary">Post accepter</a><br><br>
            ...
            @foreach($posts as $post )
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('moder.acceptPost',$post->id) }}" type="button" style="padding: 2px" class="btn  btn-sm btn-success">Accepter</a>
